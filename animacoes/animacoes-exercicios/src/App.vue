<template>
	<div id="app" class="container-fluid">
		...
		<!-- <transition name="fade" appear>
			<b-alert variant="info" show v-if="exibir"> {{ msg }} 1</b-alert>
		</transition>	

		<transition name="slide" type="animation" appear>
			<b-alert variant="info" show v-show="exibir"> {{ msg }} 2 </b-alert>
		</transition>	
		...
		<transition :name="tipoAnimacao" mode="out-in">
			<b-alert variant="info" show v-if="exibir" key="info"> {{ msg }} 2 </b-alert>
			<b-alert variant="warning" show v-else key="warn"> {{ msg }} 2 </b-alert>
		</transition>
		...
		<div class="mb-4">
			<b-button variant="primary" 
				@click="componenteSelecionado='AlertaInfo'" class="mr-2" >Info</b-button>
