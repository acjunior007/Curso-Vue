    ...
    methods: {
        ...
        setOperation(operation) {
            ...
            if(this.current === 0) {
                ...
                this.operationBefore = this.operation
        ...
        addDigit(n) {
            console.log(this.operationBefore)
            ...
            const displayValue = this.operationBefore != null ? n : currentValue + n

            this.operationBefore = null
