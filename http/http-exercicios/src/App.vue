<template>
	<div id="app" class="container">
		...
		<b-alert show dismissible v-for="(mensagem, i) in mensagens" :key="i"
		...
		<b-card>
			...
			<b-button @click="obterUsuario" size="lg" variant="success" class="ml-2">Obter usuários</b-button>	
		</b-card>
		...
		salvar() {
			...
			this.$http[metodo](`/usuarios${finalUrl}`, this.usuario)
				.then(() => {
					...
					this.obterUsuario()
					this.mensagens.push({ 
						texto: 'Operação executada com sucesso!',
						tipo: 'success'
					 })
				})
		},
